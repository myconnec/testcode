...
describe('test_name', function () {
  ...
  it('what_it_does', function () {
    ...
    cy.visit('/listings/upload/17')

    cy.get('.row > .panel > .panel-body > #new_listing_upload > #fileupload').click()

    cy.get('.row > .panel > .panel-body > #new_listing_upload > #fileupload').type('24~!@#$%^&*()_+ fps.MP4')
    ...
    cy.visit('/listings/search?utf8=%E2%9C%93&search=test&category=2&commit=SEARCH')
