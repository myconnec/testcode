...
describe('Release 1.1.8 change requests ...', function () {
    ...
    it('...search a listing.', function () {
      ...
      cy.get('input').contains('Search').click()
      cy.get('div > div.name > b > a').contains(listingData[0]['title'])
    })
